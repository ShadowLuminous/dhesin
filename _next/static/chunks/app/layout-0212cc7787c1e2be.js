(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [185],
  {
    6934: function (e, r, t) {
      Promise.resolve().then(t.t.bind(t, 8877, 23)),
        Promise.resolve().then(t.bind(t, 6404)),
        Promise.resolve().then(t.bind(t, 2362)),
        Promise.resolve().then(t.bind(t, 2478)),
        Promise.resolve().then(t.bind(t, 96)),
        Promise.resolve().then(t.bind(t, 1164)),
        Promise.resolve().then(t.t.bind(t, 2740, 23)),
        Promise.resolve().then(t.t.bind(t, 995, 23));
    },
    6404: function (e, r, t) {
      "use strict";
      var a = t(7437),
      ...
      l.ZP.registerPlugin(s.i),
        (r.default = (e) => {
          ...
          return (
            ...
            (0, a.jsx)(a.Fragment, {
              children: (0, a.jsxs)(c.f, {
                children: [
                  (0, a.jsx)("div", {
                    ref: s,
                    className:
                      "bg-[var(--foreground)] text-[var(--background)] w-full h-dvh fixed z-[11111] top-0 left-0 font-oswald preloader flex items-center justify-center pointer-events-none",
                    children: (0, a.jsx)("div", {
                      className: "font-extrabold text-4xl",
                      children: (0, a.jsx)("div", {
                        className: "overflow-hidden leading-[0.86]",
                        children: "DHESIN"
                          .split("")
                          .map((e, r) =>
                            (0, a.jsx)(
                              "span",
                              {
                                className: "inline-block snipe-[20px]",
                                children: e,
                              },
                              r
                            )
                  ...
                  (0, a.jsx)("div", {
                    className:
                      "cursor w-1 h-1 bg-[var(--dark-foreground)] rounded-full fixed mix-blend-exclusion opacity-0",
                    ref: u,
                  }),
                  (0, a.jsx)("div", {
                    className:
                      "cursor w-5 h-5 border border-[var(--dark-foreground)] rounded-full fixed mix-blend-exclusion opacity-0",
                    ref: h,
                  }),
                  (0, a.jsx)("div", {
    ...
    3129: function (e, r, t) {
      ...
      r.Z = (e) => {
        let {
            ...
            hoverColor: c = "#212121",
            hoverTxtColor: d = "#fff",
            borderColor: u = "var(--btn-border-color)",
            target: h = "_self",
            children: f,
            className: p,
          } = e,
        ...
        return (
          (0, n.useEffect)(() => {
            let e = x.current,
              r = e.querySelector(".btn-fill"),
              t = e.querySelector(".btn-text"),
              a = () => {
                l.ZP.to(t, { duration: 0.2, color: d, delay: 0.2 }),
                  l.ZP.to(r, {
                    duration: 0.6,
                    startAt: { y: "76%" },
                    y: "0%",
              ...
              s = () => {
                l.ZP.to(t, { duration: 0.2, color: i, delay: 0.3 }),
                  l.ZP.to(r, {
                    duration: 0.6,
                    y: "-76%",
                    ease: "power2.inOut",
          ...
          (0, a.jsxs)(s.default, {
            href: t,
            className: "btn ".concat(p),
            ref: x,
            style: { color: o, borderColor: u },
            target: h,
            children: [
              (0, a.jsx)("div", {
                className: "btn-fill",
    ...
    6430: function (e, r, t) {
      ...
      r.Z = (e) => {
        ...
        return (0, a.jsxs)("div", {
          ...
          onMouseEnter: () => {
            l.ZP.to(n.current.children[0].children, {
              y: "-100%",
              stagger: 0.02,
              duration: 0.3,
              ease: "power2.out",
            }),
              l.ZP.to(n.current.children[1].children, {
                y: "-100%",
                stagger: 0.02,
                duration: 0.3,
                ease: "power2.out",
            ...
            (0, a.jsx)("div", {
              children: r
                ...
                .map((e, r) =>
                  (0, a.jsx)(
                    "span",
                    { className: "inline-block", children: e },
                    r
                  )
                ),
            }),
      ...
      var u = () => {
        ...
        return (
          (0, o.V)(
            () => {
              n.ZP.from(r.current, {
                ...
                ease: "power3",
                delay: 0.2,
                scrollTrigger: { trigger: e.current, start: "clamp(top 80%)" },
              }),
                n.ZP.from(".footerTitleSvg svg", {
                  opacity: 0,
                  y: "100%",
                  skewY: 7,
                  ease: "power3",
          ...
          (0, a.jsx)(a.Fragment, {
            children: (0, a.jsx)("div", {
              className:
                "bg-foreground text-background footer-padding bg-[url('./../images/bg.png')] bg-center bg-repeat",
              style: { backgroundSize: "60px" },
              ref: e,
              id: "footer",
              children: (0, a.jsxs)("div", {
                className: "container flex flex-col w-full gap-12",
                children: [
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, a.jsxs)("div", {
                        className:
                          "flex gap-3 items-center uppercase text-sm lg:text-base cursor-pointer relative",
                        onClick: () => {
                        ...
                        children: [
                          ...
                          (0, a.jsx)("div", {
                            className:
                              "w-12 bg-background text-foreground aspect-square rounded-full flex items-center justify-center",
                            children: (0, a.jsx)("div", {
                              ...
                              children: (0, a.jsxs)("svg", {
                                ...
                                children: [
                                  ...
                                  (0, a.jsx)("path", { d: "M17 7l-10 10" }),
                                  (0, a.jsx)("path", { d: "M8 7l9 0l0 9" }),
                                ],
                              }),
                            }),
                          }),
                  ...
                  (0, a.jsxs)("div", {
                    ...
                    children: [
                      (0, a.jsx)("div", {
                        className: "overflow-hidden footerTitleSvg",
                        children: (0, a.jsxs)("svg", {
                          id: "Layer_1",
                          xmlns: "http://www.w3.org/2000/svg",
                  ...
                  (0, a.jsxs)("div", {
                    className:
                      "flex items-center justify-between font-light flex-col lg:flex-row gap-2",
                    children: [
                      (0, a.jsxs)("div", {
                      ...
                      (0, a.jsxs)("div", {
                        ...
                        children: [
                          "Design & Developed by ",
                          (0, a.jsx)("b", { children: "Dhesin Moodley" }),
                          ".",
                        ],
                      }),
                    ],
    ...
    2478: function (e, r, t) {
      ...
      var a = t(7437),
        ...
        c = t(9512),
        d = () => {
          let { theme: e, setTheme: r } = (0, c.F)(),
            t = () => {
              "light" === e ? r("dark") : r("light");
            };
          return (0, a.jsx)(a.Fragment, {
            children: (0, a.jsx)("div", {
              ...
              onClick: t,
              children: (0, a.jsxs)("div", {
                className: "thememode_icon",
                children: [
                  (0, a.jsx)("span", { className: "ray" }),
                  (0, a.jsx)("span", { className: "ray" }),
                  (0, a.jsx)("span", { className: "ray" }),
                  (0, a.jsx)("span", { className: "ray" }),
                  (0, a.jsx)("span", { className: "ray" }),
        ...
        u = () => {
          ...
          return (
            ...
            (0, a.jsx)("header", {
              className: "fixed z-10 top-0 left-0 w-full py-4",
              ref: e,
              children: (0, a.jsxs)("div", {
                className:
                ...
                children: [
                  (0, a.jsx)(l.default, {
                    href: "./index.html",
                    className: "headerFlipLink font-extrabold growCircle",
                    children: "DM",
                  }),
                  (0, a.jsxs)("nav", {
                    className: "flex gap-[var(--onetotwo)] items-center",
                    children: [
                      (0, a.jsx)(l.default, {
                        href: "./about.html",
                        children: (0, a.jsx)(s.Z, {
                          className: "headerFlipLink growCircle",
                          children: "About",
                        }),
                      }),
                      (0, a.jsx)(l.default, {
                        ...
                        onClick: (e) => {
                          e.preventDefault();
                          let r = document.getElementById("footer");
                          r &&
                            r.scrollIntoView({
                              behavior: "smooth",
                              block: "start",
          ...
          (0, l.useEffect)(() => {
            let e = () => {
              let e = new Date(),
                ...
                a = e.getSeconds(),
                l = r >= 12 ? "PM" : "AM";
              (r = String((r = r % 12 || 12)).padStart(2, "0")),
              ...
              let n = e.getTimezoneOffset(),
                o = "GMT"
                  ...
                  .concat(String(Math.abs(n) % 60).padStart(2, "0"));
              s(
                ""
                  .concat(r, ":")
                  .concat(t, ":")
  ...
  function (e) {
    e.O(0, [720, 922, 19, 138, 648, 294, 971, 23, 744], function () {
      return e((e.s = 6934));
    }),
      (_N_E = e.O());
  },
